...
faiai = []
faihuman = []
with open('Dataset & Code/dataset/raw/ai-ai-collection.json') as f:
    aiai = json.load(f)
    print(f"Raw AI-AI Length: {len(aiai)}")

with open('Dataset & Code/dataset/raw/ai-human-collection.json') as f:
    aihuman = json.load(f)
...
uaiai = []
uaihuman = []
with open('Dataset & Code/dataset/usable/u-ai-ai-collection.json') as f:
    uaiai = json.load(f)
    print(f"Usable AI-AI Length: {len(uaiai)}")

with open('Dataset & Code/dataset/usable/u-ai-human-collection.json') as f:
