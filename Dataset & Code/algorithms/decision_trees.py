...
os.makedirs('Dataset & Code/models/decision_trees', exist_ok=True)

print("-- Model 1 --")
model_m1, accuracy_m1, precision_m1, recall_m1, f1_m1 = decision_trees(data,'senti-trans', 'senti-trans-feature')
save_model(model_m1, 'Dataset & Code/models/decision_trees/model_m1.pkl')
...
save_model(model_m2, 'Dataset & Code/models/decision_trees/model_m2.pkl')
...
save_model(model_m3, 'Dataset & Code/models/decision_trees/model_m3.pkl')
...
save_model(model_m4, 'Dataset & Code/models/decision_trees/model_m4.pkl')
...
save_model(model_m5, 'Dataset & Code/models/decision_trees/model_m5.pkl')
...
save_model(model_m6, 'Dataset & Code/models/decision_trees/model_m6.pkl')
...
save_model(model_m7, 'Dataset & Code/models/decision_trees/model_m7.pkl')
...
save_model(model_m8, 'Dataset & Code/models/decision_trees/model_m8.pkl')
...
save_model(model_m9, 'Dataset & Code/models/decision_trees/model_m9.pkl')
...
save_model(model_m10, 'Dataset & Code/models/decision_trees/model_m10.pkl')
