...
estimators = []
with open("Dataset & Code/models/lightgbm/model_m1.pkl", "rb") as file:
    m1_model = pickle.load(file)
    estimators.append((f'model_m1', m1_model))

with open("Dataset & Code/models/lightgbm/model_m2.pkl", "rb") as file:
    m2_model = pickle.load(file)
    estimators.append((f'model_m2', m2_model))

with open("Dataset & Code/models/lightgbm/model_m3.pkl", "rb") as file:
    m3_model = pickle.load(file)
    estimators.append((f'model_m3', m3_model))

with open("Dataset & Code/models/lightgbm/model_m4.pkl", "rb") as file:
    m4_model = pickle.load(file)
    estimators.append((f'model_m4', m4_model))

with open("Dataset & Code/models/lightgbm/model_m5.pkl", "rb") as file:
    m5_model = pickle.load(file)
    estimators.append((f'model_m5', m5_model))

with open("Dataset & Code/models/lightgbm/model_m6.pkl", "rb") as file:
    m6_model = pickle.load(file)
    estimators.append((f'model_m6', m6_model))

with open("Dataset & Code/models/lightgbm/model_m7.pkl", "rb") as file:
    m7_model = pickle.load(file)
    estimators.append((f'model_m7', m7_model))

with open("Dataset & Code/models/lightgbm/model_m8.pkl", "rb") as file:
    m8_model = pickle.load(file)
    estimators.append((f'model_m8', m8_model))

with open("Dataset & Code/models/lightgbm/model_m9.pkl", "rb") as file:
    m9_model = pickle.load(file)
    estimators.append((f'model_m9', m9_model))

with open("Dataset & Code/models/lightgbm/model_m10.pkl", "rb") as file:
...
with open("Dataset & Code/models/lightgbm/best_lightgbm_all_ensamble+smote_models.pkl", "wb") as file:
