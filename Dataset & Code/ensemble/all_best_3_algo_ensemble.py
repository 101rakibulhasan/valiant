...
# with open("Dataset & Code/models/decision_trees/best-dt-3-models.pkl", "rb") as file:
#     dt_model = pickle.load(file)
#     new_estimetors.append(dt_model)

# with open("Dataset & Code/models/svm/best-svm-3-models.pkl", "rb") as file:
#     svm_model = pickle.load(file)
#     new_estimetors.append(svm_model)

# with open("Dataset & Code/models/random_forest/best-random_forest-3-models.pkl", "rb") as file:
#     rf_model = pickle.load(file)
#     new_estimetors.append(rf_model)

# with open("Dataset & Code/models/knn/best-knn-3-models.pkl", "rb") as file:
#     knn_model = pickle.load(file)
#     new_estimetors.append(knn_model)

# with open("Dataset & Code/models/lightgbm/best-lightgbm-3-models.pkl", "rb") as file:
#     lightgbm_model = pickle.load(file)
#     new_estimetors.append(lightgbm_model)

# with open("Dataset & Code/models/logistic_regression/best-logistic_regression-3-models.pkl", "rb") as file:
#     logistic_regression_model = pickle.load(file)
#     new_estimetors.append(logistic_regression_model)

# with open("Dataset & Code/models/naive_bayes/best-naive_bayes-3-models.pkl", "rb") as file:
#     naive_bayes_model = pickle.load(file)
#     new_estimetors.append(naive_bayes_model)

# with open("Dataset & Code/models/xgboost/best-xgboost-3-models.pkl", "rb") as file:
...
# with open("Dataset & Code/models/valiant-best_3_all_ensamble+smote_models.pkl", "wb") as file:
